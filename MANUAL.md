...
A shebang is also added to the outputfiles from Chemilang, which in turn means that these can be executed directly. An example of this is `./out.crn`, where `out.crn` is the output file generated by Chemilang.
